export const TOKENS = {
  ...
  QuestionPipeRepository: Symbol.for('QuestionPipeRepository'),
  ...
  QuestionPipeDomain: Symbol.for('QuestionPipeDomain'),
  ...
  QuestionPipeService: Symbol.for('QuestionPipeService'),
